    ...
    <div className="min-h-screen bg-stone-50 pt-14 pb-16 px-4">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="mb-8">
          <Link
            href={backLink}
            className="inline-flex items-center gap-2 text-stone-600 hover:text-red-600 transition-colors mb-4"
          >
        ...
        {!loading && meals.length === 0 && (
          <div className="text-center py-20">
            ...
            <Link href={backLink}>
              <span className="inline-flex items-center gap-2 text-red-600 hover:text-red-700 font-semibold">
                <ArrowLeft className="w-4 h-4" />
