            ...
            <form onSubmit={handleAddManual} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-stone-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500"
                  disabled={adding}
                />
              </div>
              ...
              <Button
                type="submit"
                disabled={adding}
                className="flex-1 bg-red-600 hover:bg-red-700 text-white h-12 w-full"
              >
                {adding ? (
                  <>
                    <Loader2 className="w-5 h-5 mr-2 animate-spin" />
