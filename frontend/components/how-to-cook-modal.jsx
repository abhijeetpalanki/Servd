  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogTrigger asChild>
        <button className="hover:text-red-600 transition-colors flex items-center gap-1.5 text-sm font-medium text-stone-600">
      ...
      <DialogContent className="max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pr-12 border border-stone-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500 text-stone-900 placeholder:text-stone-400"
                autoFocus
              />
              ...
              {["Butter Chicken", "Chocolate Brownies", "Caesar Salad"].map(
                (example) => (
                  <button
                    ...
                    className="px-3 py-1 bg-white text-red-700 border border-red-200 rounded-full text-sm hover:bg-red-100 transition-colors"
                  >
                    {example}
                  </button>
                ),
          ...
          <Button
            ...
            className="flex-1 w-full bg-red-600 hover:bg-red-700 text-white h-12"
          >
