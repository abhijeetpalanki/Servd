        ...
        {recipeOfTheDay && (
          <section className="mb-24 relative">
            ...
            <div className="absolute top-20 left-5 z-10 flex items-center gap-3 mb-6">
              <Badge
                variant="outline"
                className="border-2 border-red-600 text-red-700 bg-red-50 font-bold uppercase tracking-wide"
              >
            ...
            >
              <div className="relative bg-white border-2 border-stone-900 overflow-hidden hover:border-red-600 hover:shadow-lg transition-all duration-300 group cursor-pointer">
                <div className="grid md:grid-cols-2 gap-0">
                  ...
                  <div className="p-8 md:p-12 flex flex-col justify-center">
                    <div className="flex flex-wrap gap-2 mb-6">
                      <Badge
                        variant="outline"
                        className="border-2 border-red-600 text-red-700 bg-red-50 font-bold"
                      >
                    ...
                    <h3 className="text-4xl md:text-5xl font-bold text-stone-900 mb-4 group-hover:text-red-600 transition-colors leading-tight">
                      {recipeOfTheDay.strMeal}
                    </h3>
                    ...
                    <Button className="w-fit bg-red-600 hover:bg-red-700 text-white font-bold border-2 border-red-700 px-6 py-5">
        ...
        <section className="mb-24">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            {categories.map((category) => (
              ...
              >
                <div className="bg-white p-6 border-2 border-stone-200 hover:border-red-600 hover:shadow-lg transition-all text-center group cursor-pointer">
                  <div className="text-4xl mb-3">
                    {getCategoryEmoji(category.strCategory)}
                  </div>
                  <h3 className="font-bold text-stone-900 group-hover:text-red-600 transition-colors text-sm">
            ...
            {areas.map((area) => (
              <Link
                ...
                href={`/recipes/cuisine/${area.strArea
                  ...
                  .replace(/\s+/g, "-")}`}
              >
                <div className="bg-stone-50 p-5 border-2 border-stone-200 hover:border-red-600 hover:shadow-lg transition-all group cursor-pointer">
                  <div className="flex items-center gap-3">
                    <span className="text-3xl">
                      {getCountryFlag(area.strArea)}
                    </span>
                    <span className="font-bold text-stone-900 group-hover:text-red-600 transition-colors text-sm">
                      {area.strArea}
                    </span>
                  </div>
                </div>
