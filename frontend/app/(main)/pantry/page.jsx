...
import AddToPantryModal from "@/components/add-to-pantry-modal";
        ...
        <div className="mb-4">
          <div className="flex items-center justify-between mb-6">
            ...
            <Button
              ...
              className="hidden md:flex bg-red-600 hover:bg-red-700 text-white gap-2"
              size="lg"
            >
          ...
          <Button
            onClick={() => setIsModalOpen(true)}
            className="md:hidden w-full bg-red-600 hover:bg-red-700 text-white gap-2 mb-4"
            size="lg"
          >
            <Plus className="w-5 h-5" />
            Add to Pantry
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {items.map((item) => (
                <div
                  key={item.documentId}
                  className="bg-white p-5 border-2 border-stone-200 hover:border-red-600 hover:shadow-lg transition-all"
                >
                  {editingId === item.documentId ? (
                    ...
                    <div className="space-y-3">
                      <input
                        ...
                        className="w-full px-3 py-2 border-2 border-stone-200 focus:outline-none focus:border-red-600 text-sm"
