...
import { RecipePDF } from "@/components/recipe-pdf";
      ...
      <div className="min-h-screen bg-stone-50 pt-24 pb-16 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center py-20">
            <ClockLoader className="mx-auto mb-6" color="#dc0700" />
            ...
            <p className="text-stone-600 font-light">
              ...
              <span className="font-bold text-red-600">{recipeName}</span>
              ...
            </p>
            <div className="mt-8 max-w-md mx-auto">
              <div className="flex items-center gap-3 text-sm text-stone-500">
                <div className="flex-1 h-1 bg-stone-200 overflow-hidden relative">
                  <div className="absolute left-0 top-0 h-full bg-red-600 animate-slow-fill" />
                </div>
              </div>
            </div>
          </div>
    ...
    <div className="min-h-screen bg-stone-50 pt-24 pb-16 px-4">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="mb-8">
          <Link
            href="/dashboard"
            className="inline-flex items-center gap-2 text-stone-600 hover:text-red-600 transition-colors mb-6 font-medium"
          >
          ...
          <div className="bg-white p-8 md:p-10 border-2 border-stone-200 mb-6">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              <Badge
                variant="outline"
                className="text-red-600 border-2 border-red-200 capitalize"
              >
                {recipe.cuisine}
              </Badge>
              <Badge
            ...
            <div className="flex flex-wrap gap-3">
              ...
              >
                {({ loading }) => (
                  <Button
                    variant="outline"
                    className="border-2 border-red-600 text-red-700 hover:bg-red-50 gap-2"
                    disabled={loading}
                  >
        ...
        <div className="grid lg:grid-cols-3 gap-6">
                ...
                <div className="mt-6 pt-6 border-t-2 border-stone-200">
                  ...
                  >
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-red-50 p-3 text-center border-2 border-red-100">
          ...
          <div className="lg:col-span-2 space-y-6">
                  ...
                  <div
                    ...
                    className={`relative pl-12 pb-8 ${
                      index !== recipe.instructions.length - 1
                        ? "border-l-2 border-red-300 ml-5"
                        : "ml-5"
                    }`}
                  >
                    {/* Step Number */}
                    <div className="absolute -left-5 top-0 w-10 h-10 bg-red-600 text-white flex items-center justify-center font-bold border-2 border-red-700">
                      {step.step}
                    </div>
                      ...
                      {step.tip && (
                        <div className="bg-red-50 border-l-4 border-red-600 p-4">
                          <p className="text-sm text-red-900 flex items-start gap-2">
                            <Lightbulb className="w-4 h-4 mt-0.5 shrink-0 fill-red-600" />
                            <span>
            ...
            {recipe.tips && recipe.tips.length > 0 && (
              <div className="bg-linear-to-br from-red-50 to-amber-50 p-8 border-2 border-red-200">
                <h2 className="text-2xl font-bold text-stone-900 mb-4 flex items-center gap-2">
                  <Lightbulb className="w-6 h-6 text-red-600 fill-red-600" />
                  Chef&apos;s Tips & Tricks
                  {!recipeData.isPro && (
                    <span className="text-xs bg-red-100 text-red-700 px-2 py-0.5 rounded-full font-semibold">
                      PRO
                    ...
                    {recipe.substitutions.map((sub, i) => (
                      ...
                      >
                        <h3 className="font-bold text-stone-900 mb-2">
                          Instead of{" "}
                          <span className="text-red-600">{sub.original}</span>:
                        </h3>
